import 'package:educational_app/core/common/app/providers/tab_navigator.dart';
import 'package:educational_app/core/common/views/persistent_view.dart';
  ...
  final List<Widget> _screens = [
    ChangeNotifierProvider(
      create: (_) => TabNavigator(TabItem(
          child:
              BlocProvider(create: (_) => sl<CourseCubit>(), child: HomeView()))),
